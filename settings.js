...
global.pengguna = '© 𝐰𝐚𝐧𝐝𝐚 𝐜𝐚𝐤𝐞𝐩' // Your name ඔබේ නම 
global.botnma = '𝐒𝐀𝐍𝐒 𝐁𝐎𝐓' // Your bot name , ඔබගෙ බොට්ගේ නම 
global.ownernma = '𝖜𝖆𝖓𝖉𝖆 𝖕𝖗𝖆𝖘𝖊𝖙𝖞𝖆' //ownernama,ownername
global.packname = 'punya wanda' // Sticker package name 
global.author = '©bye wanda' // Sticker Autor name 
...
global.welcome = `
🌀 Thanks For using sans bot
✾ Some bugs fixing
😼♥️
`
// වෙල්කම් එක යවන්න ඔනි නම් add කියලා දාන්න 
global.sendwelcome = `add`
// Good bye Anak 🐶 එක ඔනි නම් remove කියලා දාන්න
global.sendgoodbye = `remove`
// Caption 
global.cap = `© 𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐁𝐲 𝐒𝐚𝐧𝐬 𝐁𝐨𝐭`
global.mess = {
    success: '✅ Done!',
    admin: 'you must be admin to use this cmd!',
    botAdmin: 'Bot must be admin neh!',
    owner: 'This cmd is for Sansbot owner only',
    group: 'oooh sorry this cmd is for groups only!',
    private: 'goossssh it can only used in dms!',
    bot: 'This cmd  its only for the bot host',
    wait: 'Wait Sans Bot processing ',
